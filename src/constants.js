...
export default {
  ...
  BANNED_LABELS: [
    ...
    "circle", // when scaled down, always detected as an octagon
    "hexagon", // too similar to octagon
    "stitches", // too similar to lightning/zigzag
    "sweater", // too similar to "jacket"
  ...
  MODELNAMEMAP: {
    "JoshuaKelleyDs/quickdraw-MobileVIT-small-finetune": "MobileVIT-V1-Small",
    "JoshuaKelleyDs/quickdraw-MobileVIT-xxs-finetune": "MobileVIT-V1-XXS",
  ...
  MODELPARAMS: {
    ...
    "JoshuaKelleyDs/quickdraw-MobileVIT-xxs-finetune": "1.07M",
    "JoshuaKelleyDs/quickdraw-DeiT-tiny-finetune": "5.44M",
    "JoshuaKelleyDs/quickdraw-MobileVITV2-1.0-Finetune": "4.58M",
    "JoshuaKelleyDs/quickdraw-MobileVITV2-2.0-Finetune": "17.8M",
    "JoshuaKelleyDs/quickdraw-ConvNeXT-Tiny-Finetune": "28.1M",
    "JoshuaKelleyDs/quickdraw-ConvNeXTV2-Tiny-Finetune": "28.1M",
  },
  tableStyleOptionsArray: [
    {
